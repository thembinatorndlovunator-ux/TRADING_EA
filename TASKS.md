...
|---|---|---|---|---|---|
| TASK-001 | Baseline audit: SmartCoreEngine V6.37 & NdlovuSMC V8.11 | `claude/task-001-baseline-audit` | In progress — awaiting Codex review | 2026-07-19 | `TASK-001_BASELINE_AUDIT.md` |
