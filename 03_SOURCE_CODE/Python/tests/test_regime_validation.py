...
def test_invalid_efficiency_window_out_of_range():
    result = classify(
        TREND_CLOSES, [0.0, 1.0], 1.0, 100.0, 100.0, 50.0,
        efficiency_window=10, trend_threshold=0.6, expansion_threshold=0.75,
        compression_threshold=0.25, min_efficiency=0.3, trend_slope_atr_divisor=0.5,
        swing_agreement=0.0, direction_agree=False,
    )
...
def test_invalid_insufficient_atr_history():
    result = classify(
        TREND_CLOSES, [1.0], 1.0, 100.0, 100.0, 50.0, **COMMON_KWARGS,
        swing_agreement=0.0, direction_agree=False,
    )
    assert result.valid is False
...
def test_invalid_non_positive_current_atr():
    result = classify(
        TREND_CLOSES, [0.0, 1.0, 1.0], 0.0, 100.0, 100.0, 50.0, **COMMON_KWARGS,
        swing_agreement=0.0, direction_agree=False,
    )
    assert result.valid is False
...
def test_ranging_via_efficiency_failure():
    result = classify(
        CHOPPY_CLOSES, [0.0, 0.5, 0.5], 1.0, 100.0, 100.0, 50.0, **COMMON_KWARGS,
        swing_agreement=0.0, direction_agree=False,
    )
...
def test_trending_up():
    ...
    result = classify(
        TREND_CLOSES, [0.0, 2.0, 2.0], 1.0, ema_now=105.0, ema_prior=100.0, adx_now=50.0,
        **COMMON_KWARGS, swing_agreement=1.0, direction_agree=True,
    )
...
def test_trending_down():
    result = classify(
        TREND_CLOSES, [0.0, 2.0, 2.0], 1.0, ema_now=95.0, ema_prior=100.0, adx_now=50.0,
        **COMMON_KWARGS, swing_agreement=1.0, direction_agree=True,
    )
...
def test_volatility_expansion_up():
    ...
    result = classify(
        TREND_CLOSES, [0.0, 1.0, 1.0], 2.0, ema_now=105.0, ema_prior=100.0, adx_now=50.0,
        **COMMON_KWARGS, swing_agreement=1.0, direction_agree=True,
    )
...
def test_volatility_expansion_down():
    result = classify(
        TREND_CLOSES, [0.0, 1.0, 1.0], 2.0, ema_now=95.0, ema_prior=100.0, adx_now=50.0,
        **COMMON_KWARGS, swing_agreement=1.0, direction_agree=True,
    )
...
def test_transition_when_expansion_but_direction_disagrees():
    result = classify(
        TREND_CLOSES, [0.0, 1.0, 1.0], 2.0, ema_now=105.0, ema_prior=100.0, adx_now=50.0,
        **COMMON_KWARGS, swing_agreement=0.0, direction_agree=False,
    )
...
def test_compression():
    ...
    result = classify(
        TREND_CLOSES, [0.0, 5.0, 5.0], 1.0, ema_now=100.0, ema_prior=100.0, adx_now=50.0,
        **COMMON_KWARGS, swing_agreement=0.0, direction_agree=False,
    )
...
def test_ranging_via_middle_zone_fallback():
    ...
    result = classify(
        TREND_CLOSES, [0.0, 0.5, 2.0], 1.0, ema_now=100.0, ema_prior=100.0, adx_now=50.0,
        **COMMON_KWARGS, swing_agreement=0.0, direction_agree=False,
    )
    assert result.regime == Regime.RANGING
